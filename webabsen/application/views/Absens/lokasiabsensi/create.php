...
<div class="modal fade" id="modal_tambah">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<?= form_open('Absens/LokasiAbsensi/store', ['class' => 'form_create']) ?>
			<div class="modal-body">

				<div class="form-group">
					<label>Id Set Lokasi</label>
					<input type="text" name="idlokasi" class="form-control" placeholder="Id Set Lokasi">
				...
				<div class="form-group">
					<label>Lokasi</label>
					<textarea type="text" name="lokasi" class="form-control" placeholder="Lokasi"></textarea> 
