<div class="modal fade" id="modal_edit">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<?= form_open('master/Matapelajaran/update', ['id' => 'edit', 'class' => 'form_edit'], ['kode' => $data['idmapel']]) ?>
			<div class="modal-body">
				<div class="form-group">
					<label>Mata Pelajaran</label>
					<input type="text" name="matapel" class="form-control" value="<?= $data['namamapel'] ?>">
					<span class="error nama text-red"></span>
				</div>

				<div class="form-group">
					<label>Mata Pelajaran</label>
					<input type="text" name="singkatan" class="form-control" value="<?= $data['singkatanmapel'] ?>">
					<span class="error nama text-red"></span>
				</div>
			</div>
