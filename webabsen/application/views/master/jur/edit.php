<div class="modal fade" id="modal_edit">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<?= form_open('master/Jurusan/update', ['id' => 'edit', 'class' => 'form_edit'], ['kode' => $data['id_jurusan']]) ?>
			<div class="modal-body">
				<div class="form-group">
					<input type="text" name="nama" class="form-control" placeholder="Contoh Jurusan  : (IPA) Peminatan Ilmu Pengetahuan Alam" value="<?= $data['nama_jurusan'] ?>">
		...
		$.ajax({
			...
			success: function(response) {
				...
				if (response.status == false) {
					...
					window.location.href = "<?= site_url('jr') ?>";
				}
			},
			complete: function() {
