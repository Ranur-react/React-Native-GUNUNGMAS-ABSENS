...
LOCK TABLES `absen_keluar` WRITE;
...
LOCK TABLES `jadwal_absen_karyawan` WRITE;
...
LOCK TABLES `set_waktu_absens` WRITE;
...
(6,'K002','nur@gmail.com','202cb962ac59075b964b07152d234b70','3','1','2021-01-27 18:25:02');
