...
CREATE TABLE `absen_keluar` (
  ...
  CONSTRAINT `absen_keluar_ibfk_2` FOREIGN KEY (`id_set_waktu_keluar`) REFERENCES `set_waktu_absens` (`id_waktu`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `absen_keluar` */

insert  into `absen_keluar`(`id_absen_keluar`,`id_karyawan_keluar`,`id_set_waktu_keluar`,`jam_keluar`,`tanggal_keluar`,`latitude_keluar`,`longitude_keluar`,`foto_keluar`) values 
('kl01','K001','W03','13:13:00','2021-02-05','96htpgl49u--l','ei7frf.e;r049','koa'),
('kl02','K002','W04','17:24:00','2021-02-08','96htpgl49u--l','ei7frf.e;r049','koa');
...
CREATE TABLE `absen_masuk` (
  ...
  CONSTRAINT `absen_masuk_ibfk_2` FOREIGN KEY (`id_set_waktu_masuk`) REFERENCES `set_waktu_absens` (`id_waktu`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `absen_masuk` */

insert  into `absen_masuk`(`id_absen_masuk`,`id_karyawan_masuk`,`id_set_waktu_masuk`,`jam_masuk`,`tanggal_masuk`,`latitude_masuk`,`longitude_masuk`,`foto_masuk`,`ket`) values 
('ms01','K001','W03','08:15:00','2021-02-05','96htpgl49u--l','ei7frf.e;r049','koha','hadir'),
('ms02','K002','W04','13:08:00','2021-02-08','96htpgl49u--l','ei7frf.e;r049','koha','hadir');
...
('J001','K001','2021-02-04',NULL,NULL),
('J001','K002','2021-02-04',NULL,NULL),
('J001','K001','2021-02-05',NULL,NULL),
('J001','K002','2021-02-05',NULL,NULL),
('J001','K001','2021-02-06',NULL,NULL),
('J001','K002','2021-02-06',NULL,NULL);
