...
CREATE TABLE `detail_jadwal` (
  ...
  KEY `id_karyawan_detail` (`id_karyawan_detail`),
  ...
  CONSTRAINT `detail_jadwal_ibfk_2` FOREIGN KEY (`id_karyawan_detail`) REFERENCES `karyawan` (`id_karyawan`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(10,'K001','rizky@gmail.com','202cb962ac59075b964b07152d234b70','2','1','2021-01-27 22:53:54'),
(12,'K002','akir@gmail.com','202cb962ac59075b964b07152d234b70','2','1','2021-01-27 23:35:52');
