...
let Menu=(props)=>{
 ...
 //From Base------
  ...
  render() {
        console.log(this.state.MasukState.pesan);
        let code=[];
              const listOBJ ={
                0:{nama:'Absen Masuk',icon:'Enter',status: this.state.MasukState.state, color:'',dest:"Capture"},
                1:{nama:'Absen Pulang',icon:'Exit',status: this.state.PulangState.state, color:'',dest:"AfterCapture"},
