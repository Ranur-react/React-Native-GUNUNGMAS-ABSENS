...
const App = (props) => {
console.log("Nilai Props File Upload");
    ...
    <SafeAreaView style={{flex: 1}}>
                <View style={styles.Form}>
                    <Text style={styles.Label}>Upload Surat (.Pdf)</Text>
                      <Text style={[styles.FormInput,{paddingLeft:80,color:'rgba(50,50,50,0.5)',paddingTop:12}]}   > {props.singleFile ? props.singleFile : 'Klik Untuk Upload Dokumen Bukti'}  </Text>
