...
export default class MyComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      Foto: 'https://billatowing.com/wp-content/uploads/2016/06/team-1.jpg',
      Time: this.props.ShootTime,
      tmpImg: 'https://billatowing.com/wp-content/uploads/2016/06/team-1.jpg',
    };
  }
  componentDidUpdate() {
    () => {
