...
export default class MyComponent extends Component {
  ...
  ProseJadwal = () => {
    ...
    let GetDataFromDB = async () => {
      console.log('===============urla yang di get=====================');
      console.log(APIDOMAINWEB + '/AuthApp/JadwalCek');
      console.log('====================================');
      console.log('ID karyawan xxx');
      ...
      fetch(APIDOMAINWEB + '/AuthApp/JadwalCek', {
        ...
        .then(responseJson => {
          console.log('==================Ambil jadwal absen=================');
  ...
  getDataLoginJson = async () => {
    let jsonValue = await AsyncStorage.getItem('Json_Login');
  ...
  CallStorageData = async () => {
    await this.getDataLoginJson();
  };
  UNSAFE_componentWillMount() {
    //tarok pemanggilan user disini
    this.CallStorageData();
    console.log('==============From state user======================');
