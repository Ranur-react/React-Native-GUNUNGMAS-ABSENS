...
const DESK = (props) => {
  if (props.actions) {
    return (
      <View >
        <Svgicon key={20} color="rgba(50,50,50,0.5)" name="Refresh-M" />
      </View>
    )
  } else {
    return (
      <View>
        <Deskripsiabsen key={31} />
      </View>
    )
  }
...
const HISTODESK = (props) => {
  if (props.actions) {
    return (
      <View >
        <Svgicon key={16} color="rgba(50,50,50,0.5)" name="Refresh-M" />
      </View>
    )
  } else {
    return (
...
const Menu = (props) => {
  if (props.actions) {
    return (
      <View >
        <Svgicon key={18} color="rgba(255,255,255,0.5)" name="Refresh-M" />
      </View>
    )
  } else {
    return (
      <Menuabsen key={19} color="black" props={props.props} />
        ...
        <ScrollView refreshControl={
          ...
          >
            ...
            <TouchableOpacity onPress={this.Refresh} style={styles.IconBox}>
              <Svgicon key={17} color="rgba(76,169,255,0.5)" name="Refresh-M" />
            </TouchableOpacity>
          </View>
        </ScrollView>
      </View>
